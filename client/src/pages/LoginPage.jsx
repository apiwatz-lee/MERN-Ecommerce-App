    ...
    <>
        <main className='bg-shopping bg-cover w-screen h-screen font-poppins'>
            ...
            <section className='w-full h-full flex flex-col justify-center items-center'>
                <form onSubmit={handleLogin} className='p-5 w-[280px] sm:w-[400px] h-[600px] rounded-3xl flex flex-col justify-center items-center gap-10 backdrop-opacity-5 bg-gray-950 bg-opacity-90 shadow-2xl'>
